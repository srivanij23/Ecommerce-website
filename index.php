...
<header>
    <div class="header-container">
        ...
        <p class="subheading">Your One-Stop Shop for Everything You Love!</p>
        <nav>
            <a href="pages/login.php">Login</a>
            <a href="pages/register.php">Register</a>
            <a href="pages/cart.php" class="cart-link">
                <img src="images/cartt.png" alt="Cart" class="cart-icon"> Cart
            </a>
            <!-- "My Orders" link -->
            <a href="pages/orders.php" class="orders-link">My Orders</a>
            <!-- Logout button -->
